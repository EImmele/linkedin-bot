...
async function main() {
    try {
        console.log("Publishing Post 1 via Composio proxyExecute...");
        const payload = {
        ...
        console.log("Proxy Result Status:", result.status);
        console.log("Proxy Result Data:", JSON.stringify(result.data, null, 2));
    } catch (e) {
